...
import com.example.tugas_day_4_app.databinding.FragmentUserABinding

class UserAFragment : Fragment() {

    private lateinit var binding: FragmentUserABinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentUserABinding.inflate(inflater, container, false)
        return binding.root
    }
